...
Click the 'Get Users' button to show all users with screen names and names.
...
To search for a tweet, enter an ID(it is really important. It is an ID, not users ID) and then click on the 'Search' button.
